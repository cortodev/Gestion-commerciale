Adresse.create [
  ...
  { destinataire: "Restaurant Les Grands Ducs", rue: "3 avenue de la porte Maillot", ville: "Paris", code_postal: "75116" },
...
Produit.create [
  { ref: "FG128", nom: "Bloc de foie gras 3*", puht: 20, quantite: 250 , unite: "gr", duree_conservation: 14 },
  { ref: "S40", nom: "Saumon fume sauvage pretanche", puht: 28.5, quantite: 1000 , unite: "gr", duree_conservation: 20 },
  { ref: "T12", nom: "Terrine de lapin", puht: 12, quantite: 1000 , unite: "gr", duree_conservation: 6 },
  { ref: "T13", nom: "Terrine de lapin aux morilles", puht: 15, quantite: 1000 , unite: "gr", duree_conservation: 4 },
  { ref: "T25", nom: "Terrine de lievre aux noisettes", puht: 18.50, quantite: 1000 , unite: "gr", duree_conservation: 4 },
...
Produit.all.each do |produit|
  Agence.all.each do |agence|
    s = Stock.create( { quantite_disponible: 50, date_fabrication: Time.now, produit: produit, agence: agence } )
  end
end
...
ContactClient.create [
  { email: "marcel.durand-lesgrandsducs@yahoo.com", prenom: "Marcel", nom: "Durand", telephone: "0147869090", position: "Responsable des achats", password: "12345", password_confirmation: "12345", agence: Agence.first },
  { email: "charlotte.legrand@sanofis-traiteur.com", nom: "Legrand", prenom: "Charlotte", telephone: "0652831780", position: "Directrice commerciale", password: "abcd", password_confirmation: "abcd", agence: Agence.first }
]

ducs = Client.find_by_raison_sociale( "Restaurant Les Grands Ducs" )
ducs.adresse = Adresse.find_by_destinataire "Restaurant Les Grands Ducs"
ducs.ristournes.create! [
  { ca_min: 45000, ca_max: 90000, valeur: 3 },
  { ca_min: 90000, valeur: 5 }
]
durand = Utilisateur.find_by_nom "Durand"
durand.adresses << ducs.adresse
durand.client = ducs
...
legrand.adresses << Adresse.find_by_destinataire( "Traiteur Sanofis Paris" )
